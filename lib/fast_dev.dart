...
///
/// 当前实现 assets / fonts 代码生成。CLI（`dart run fast_dev`）和
/// `build_runner` Builder 在同一个包里。colors / import 整理的扩展方式见
/// [Generator] 与文档站计划页。
library;
...
export 'src/generate/fonts/generate.dart';
export 'src/generate/fonts/generator.dart';
